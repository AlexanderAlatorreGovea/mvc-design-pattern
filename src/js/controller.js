...
const showRecipe = async () => {
  try {
    ...
    const res = await fetch(
      `https://forkify-api.herokuapp.com/api/v2/recipes/${id}?key=${process.env.API_KEY}`
      //'https://forkify-api.herokuapp.com/api/v2/recipes?search=pizza&key=5ed6604591c37cdc054bc886?key=2926f6ca-5c98-4277-8a8e-369020c9168a'
    );
